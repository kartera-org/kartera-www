...
const Nav: React.FC<NavProps> = ({ onDismiss, mobileMenu }) => {
  return (
    <>
      ...
      <StyledNav>
        <StyledRouterLink target="/dashboard" label="Home" mobileMenu={mobileMenu} onDismiss={onDismiss} />
        <StyledRouterLink target="/umbrella" label="Basket" mobileMenu={mobileMenu} onDismiss={onDismiss}>
